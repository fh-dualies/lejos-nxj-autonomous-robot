...
/**
 * RemoteLogEvent is an domain.event that represents a log message generated by the robot.
...
public class RemoteLogEvent extends AbstractEvent implements IExposableEvent {
  /**
   * The log message that generated the domain.event.
   */
   ...
   *
   * @param message the log message that generated the domain.event
   */
